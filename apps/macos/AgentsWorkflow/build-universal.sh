#!/bin/bash
# Build script for AgentsWorkflow with universal binary support
...
echo "Building universal binaries for AgentsWorkflow..."
...
echo "  cd apps/macos/AgentsWorkflow"
echo "  xcodebuild build -project AgentsWorkflow.xcodeproj -scheme AgentsWorkflow -configuration Release"
echo ""
