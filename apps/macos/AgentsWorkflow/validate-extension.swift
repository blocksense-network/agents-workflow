...
//
//  Validates that a built AgentsWorkflow app contains a properly configured extension
//  Usage: swift validate-extension.swift /path/to/AgentsWorkflow.app
//

import Foundation

func validateExtension(at appPath: String) -> Int {
    print("AgentsWorkflow Extension Validator")
    print("===================================")

    let extensionIdentifier = "com.agentsworkflow.AgentFSKitExtension"
    var exitCode = 0
...
if CommandLine.arguments.count != 2 {
    print("Usage: \(CommandLine.arguments[0]) <path-to-AgentsWorkflow.app>")
    print("Example: \(CommandLine.arguments[0]) /path/to/build/AgentsWorkflow.app")
    exit(1)
}
