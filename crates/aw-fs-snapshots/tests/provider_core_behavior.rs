...
pub trait ProviderCoreTestBehavior {
    ...
    fn create_test_provider(&self) -> aw_fs_snapshots_traits::Result<Box<dyn FsSnapshotProvider>>;
    ...
    fn create_workspace_destination(
        ...
        let timestamp = std::time::SystemTime::now()
            ...
            .map_err(|e| aw_fs_snapshots_traits::Error::provider(format!("Time error: {}", e)))?
            .as_secs();
