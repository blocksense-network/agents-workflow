...
use aw_rest_api_contract::SessionEvent;
...
pub enum RestSuccessMsg {
    ...
    ProjectsList(Vec<aw_rest_api_contract::Project>),
    /// Repositories list response
    RepositoriesList(Vec<aw_rest_api_contract::Repository>),
    /// Agents list response
    AgentsList(Vec<aw_rest_api_contract::AgentCapability>),
    /// Task creation response
    TaskCreated(aw_rest_api_contract::CreateTaskResponse),
}
