...
/// Represents a task in the AW system.
    ...
    pub fn to_aw_core_task(&self) -> crate::Result<aw_core::Task> {
        ...
        Ok(aw_core::Task {
            ...
            status: match self.status {
                TaskStatus::Pending => aw_core::TaskStatus::Pending,
                TaskStatus::Running => aw_core::TaskStatus::Running,
                TaskStatus::Completed => aw_core::TaskStatus::Completed,
                TaskStatus::Failed => aw_core::TaskStatus::Failed,
                TaskStatus::Cancelled => aw_core::TaskStatus::Cancelled,
            },
