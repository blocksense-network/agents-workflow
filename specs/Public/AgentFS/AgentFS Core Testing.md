...
Prereq: libfuse available; adapter binary built.
...
Prereq: WinFsp installed; adapter built.
...
Prereq: FSKit extension built and signed; XPC client available.
...
#### P1. Microbench baseline (performance)
